...
<template>
    <div class="container">
        ...
        <main>
            ...
            <!-- Output Panel -->
            <OutputPanel :result="state.result" :solution="state.solution" :time="state.executionTime"
                :tokens="state.tokens" :html="state.html" :latex="state.latex" :error="state.error" />
        </main>
    </div>
</template>
